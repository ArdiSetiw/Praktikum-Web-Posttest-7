<?php
    ...
    if (isset($_POST['update'])){
        ...
        if(move_uploaded_file($temp, 'mbl/'.$image)){
            ...
            $sql = "UPDATE data_mobil SET merek='$merek', model='$model', harga='$harga', gambar='$image', tanggal='$date' WHERE id_mobil='$id' ";
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table id="tab_add">
                ...
                <tr>
                    ...
                    <td align=center>
                        <input class ='add' type="file" name="img" required>
                    </td>
                <tr>
